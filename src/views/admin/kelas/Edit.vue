<template>
	<div class="card shadow">
		<div class="card-header">
			<router-link :to="{ name: 'kelas.data' }" class="btn btn-light btn-sm">
...
<script>
	...
	export default {
		...
		methods: {
			...mapActions('kelas', ['updateKelas','getKelas'] ),
			submit() {
				this.updateKelas(this.$route.params.id)
				.then((res) => {
